...
from modeltrain import model_train_VADE,model_train_simclr
import yaml
...
if __name__ == "__main__":
    ...
    train_dataset = Loading_Dataset.cryoEM_Dataset_from_path(path_mrcdata=path_data,
                                                             ...
                                                             syn_rand_rotate=transforms.RandomRotation(
                                                                 degrees=(-180, 180)) if cfg['augmentation_kwargs']['phase 1'][
    ...
    val_dataset = Loading_Dataset.cryoEM_Dataset_from_path(path_mrcdata=path_data,
                                                           ...
                                                           cfg['augmentation_kwargs']['phase 1']['rand_rotate'] else None,
                                                           is_Normalize=cfg['augmentation_kwargs']['phase 1']['is_Normalize']
                                                           )
    ...
    transform_p2=get_config.get_train_transformations(cfg['augmentation_kwargs']['phase 2'])

    # model_train_simclr.train_model_round2(val_dataloader, epoches_round2, model,
    #                                    run_root_dir, tb_writer,  transform_p2, batch_size, train_data=train_dataloader,cluster_num=cluster_num,
    ...
    model_train_VADE.train_model_round2(val_dataloader, epoches_round2, model,
                                       run_root_dir, tb_writer,optimizer,  transform_p2, batch_size, train_data=train_dataloader,cluster_num=cluster_num,
                                       is_simulated_dataset=cfg['is_simulated_dataset'], nw=nw,
                                       kmeans_mode=cfg['kmeans_mode'])
    # For calculating the time cost
